        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../../r&s/r&s.html">Rate Restaurants/Stores</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="improvements.php">Improvements for University</a>
                    </li>
    ...
    <div class="container">
        <main class="my-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <img src="../../images/bulldogBall.png" alt="" class="img-fluid">
                    </div>
                    <div class="col-md-5">
                        <h1>Improvements</h1>
                        <p class="mt-4">
                            Welcome to the Improvements section of RateNCAT. In
                            this section, you are able to leave feedback on what NCAT can do
                            to make the school better. Please be respectful when typing these
                            comments.
                        </p>
                    </div>
                </div>
    	...
    	<div class="card">
    		<div class="card-header text-center fw-bold">North Carolina A&T State University</div>
    		<div class="card-body">
    			<div class="row">
