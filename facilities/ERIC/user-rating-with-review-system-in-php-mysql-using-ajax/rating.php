        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="../../../facilities/facilities.html">Rate Facilities</a>
                    </li>
                    <li class="nav-item">
...
<br>
    <div class="container">
    	<div class="card">
    		<div class="card-header text-center fw-bold">Engineering Research & Innovation Complex</div>
    		<div class="card-body">
    			<div class="row">
